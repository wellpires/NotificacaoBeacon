...
public class Email extends javax.mail.Authenticator {
    ...
    public Email() {
        ...
        _user = "controlereunioespoc@gmail.com"; // usuário
        _pass = "everis@2017"; // senha
        _from = "controlereunioespoc@gmail.com"; // email do remetente
        _subject = "Controle de reuniões"; // assunto
        _body = ""; // mensagem html
